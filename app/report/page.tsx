  ...
  return (
    <Shell active="report" title="Statistics & Report" crumb="Statistics & Report" updatedText={`Updated ${new Date(usage.generatedAt).toLocaleTimeString("en-US", { hour: "2-digit", minute: "2-digit" })}`} windowLabel={windowLabel} toolbar={toolbar} assistant={<Group6Assistant data={dash} range={range} rangeLabel={windowLabel} />}>
      ...
      <MetricSection group="relationship">
        <div className="section-head"><h2 className="eyebrow">Relationship</h2><span className="section-sub">prompts x tokens x revenue, per account</span></div>
      ...
      <MetricSection group="tax">
        ...
        <div className="mb-24">
          <StatGrid>
            ...
            <StatTile label={`Expected @ ${tax.ratePct}%`} value={money(tax.expected)} tone="neutral" sub="base x rate" />
      ...
      <MetricSection group="ar">
        <div className="section-head"><h2 className="eyebrow">Accounts receivable</h2><span className="section-sub">billed to collected to exceptions, from BILL_T</span></div>
        <div className="mb-24">
          <StatGrid>
