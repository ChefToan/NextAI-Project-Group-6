...
function buildPrompt(message: string, context: unknown, history: ChatHistoryItem[]) {
  return [
    ...
    "Scope is Group 6 (/service/nextaig6): LLM token/prompt usage, billed revenue, L01-L10 usage-intensity buckets, plan/product mix, tax, AR, exceptions, pricing, and the Odyssey 3.0 vs 3.5 model split.",
    "L01-L10 are usage-intensity buckets, not plan tiers.",
